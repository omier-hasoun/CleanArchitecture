...
public sealed class PasswordHasher : IPasswordHasher
{
    ...
    public string Hash(string passwordPlain)
    {
        ...
        byte[] hash = Rfc2898DeriveBytes.Pbkdf2(passwordPlain, salt, _iterations, _hashAlgorithm, _hashSize);
    ...
    public bool Verify(string passwordPlain, string passwordHash)
    {
        ...
        byte[] inputHash = Rfc2898DeriveBytes.Pbkdf2(passwordPlain, salt, _iterations, _hashAlgorithm, _hashSize);
